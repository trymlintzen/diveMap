...
class SearchTableViewController: UITableViewController , UISearchBarDelegate{
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(SearchTableViewController.resultSearchObservers(notification:)),
                                               name: NSNotification.Name(rawValue: notificationIDs.tableResultID),
                                               object: nil)
